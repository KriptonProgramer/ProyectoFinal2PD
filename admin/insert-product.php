										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="productName"
													placeholder="Ingrese nombre del producto" class="span8 tip" required>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="productCompany"
													placeholder="Ingrese marca del producto" class="span8 tip" required>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Precio de producto sin
												descuento</label>
											<div class="controls">
												<input type="text" name="productpricebd"
													placeholder="Ingrese descuento del producto" class="span8 tip" required>
											</div>
										</div>

										<div class="control-group">
											<label class="control-label" for="basicinput">Precio del producto con
												descuento(Precio de venta)</label>
											<div class="controls">
												<input type="text" name="productprice" placeholder="Ingrese precio de venta"
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea name="productDescription"
													placeholder="Ingrese descripción del producto" rows="6"
													class="span8 tip">
																		</textarea>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="productShippingcharge"
													placeholder="Ingres costo de envio" class="span8 tip" required>
											</div>
										</div>
