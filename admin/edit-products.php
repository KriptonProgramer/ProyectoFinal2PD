						...
						<div class="content">
							...
							<div class="module">
								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post"
										...
										while ($row = mysqli_fetch_array($query)) {
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Precio de venta del
													producto</label>
												<div class="controls">
								...
								<?php echo htmlentities($row['productDescription']); ?>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="productShippingcharge"
														placeholder="Ingresa costo de envio del producto"
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Disponibilidad del
													Producto</label>
												<div class="controls">
											...
											<div class="control-group">
												...
												<div class="controls">
													<img src="/pf/admin/productimages/<?php echo htmlentities($pid); ?>/<?php echo htmlentities($row['productImage1']); ?>"
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Imagen 01 del producto</label>
												<div class="controls">
													<img src="/pf/admin/productimages/<?php echo htmlentities($pid); ?>/<?php echo htmlentities($row['productImage2']); ?>"
														width="200" height="100"> <a
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Imagen 01 del producto</label>
												<div class="controls">
													<img src="/pf/admin/productimages/<?php echo htmlentities($pid); ?>/<?php echo htmlentities($row['productImage3']); ?>"
														width="200" height="100"> <a
